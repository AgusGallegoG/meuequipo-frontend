...
import matchTeamsListMock from '@/rivals/infrastructure/mocks/rivalsMatchTeamsListMock.json';
...
async function getRivalMatchTeamsByCategory(categoryId: number): Promise<MatchTeam[]> {
  try {
...
export { getRivalMatchTeamsByCategory };
